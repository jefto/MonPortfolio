...
const socialLinks = [
    ...
    { name: "Twitter/X", url: "https://twitter.com", icon: "M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" }
];
        ...
        <div className="min-h-screen bg-black text-green-400 font-mono relative overflow-hidden">
            ...
            <div className="relative z-10 p-8 md:p-16">
                ...
                <header className={`mb-16 transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-10'}`}>
                    ...
                    <h1 className="text-4xl md:text-6xl font-bold text-green-400 mb-4 drop-shadow-[0_0_10px_rgba(0,255,0,0.5)]">
                        <TerminalText text="DÉVELOPPEUR WEB" delay={80} />
                    </h1>
                    <p className="text-green-500/80 text-lg md:text-xl max-w-2xl">
